...
open class SentPing(
    ...
    @ColumnInfo(name = "sent_hour") var sentHour: String,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return id == other.id && pingId == other.pingId && leadId == other.leadId && sentHour == other.sentHour && reaction == other.reaction
    }
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + sentHour.hashCode()
