...
sealed interface ToolEvent : GenericEvent {
    ...
    data class SetRecordingsFolder(val recordingsFolder: String) : ToolEvent
    object SwitchRecordingsEnabled : ToolEvent
    ...
    object SwitchPinPointInteractions : ToolEvent
    ...
    object SwitchStopRecordingOnNewEntryEnable: ToolEvent
}