...
fun GenericSelectingButton(
    ...
    val textBackgroundColor =
        if (currentSelect == selectType) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.primaryContainer
    val textButtonColor =
        if (currentSelect == selectType) MaterialTheme.colorScheme.onSurfaceVariant else MaterialTheme.colorScheme.onPrimary
