...
interface SettingDao {
    companion object {
        ...
        const val EXPORT_SENT_PINGS_FILE_NAME_ID: String = "export_sent_pings_file_name"
        const val IMPORT_SENT_PINGS_FILE_NAME_ID: String = "import_sent_pings_file_name"
        ...
        const val STOP_RECORDING_ON_NEW_ENTRY_ENABLED_ID: String = "stop_recording_on_new_entry_enabled"
        ...
        const val DEFAULT_STOP_RECORDING_ON_NEW_ENTRY_ENABLED: String = "false"
    ...
    @Query("SELECT CASE COUNT(*) WHEN 0 THEN '${DEFAULT_SENT_PINGS_EXPORT_FILE_NAME}' ELSE value END FROM setting WHERE id = '${EXPORT_SENT_PINGS_FILE_NAME_ID}'")
    fun getExportSentPingsFilename(): Flow<String>
    ...
    @Query("SELECT CASE COUNT(*) WHEN 0 THEN '${DEFAULT_STOP_RECORDING_ON_NEW_ENTRY_ENABLED}' ELSE value END FROM setting WHERE id = '${STOP_RECORDING_ON_NEW_ENTRY_ENABLED_ID}'")
    fun getStopRecordingOnNewEntryEnabled(): Flow<String>
