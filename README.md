...
| Column name | Details |
| ----------- | ------- |
| Date Id | Primary Key Autogenerated Not Null |
| Lead Id | Foreign Key Lead Id Default Null |
| Location | String Default Null |
| Start Time | String Default Null |
| End Time | String Default Null |
| Cost | Double Default Null |
| Date Number | Int Default Null |
| Pull | Boolean Default Null |
| Bounce | Boolean Default Null |
| Kiss | Boolean Default Null |
| Lay | Boolean Default Null |
| Recorded | Boolean Default Null |
| Sticking Points | String Default Null |
| Tweet | String Default Null |
